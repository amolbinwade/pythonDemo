...
up.stepSep()
fileName = up.get_file_to_process()
...
print("Searched the matching files for {} in all {} child directories. "
      "Found {} matching files.".format(fileName,up.file_dir_in_root.__len__(), up.all_files.__len__()))
...
print("Searched the matching files for {} in {} selected child directories. "
      "Found {} matching files.".format(fileName, up.selected_dirs.__len__(), up.file_list_in_sel_dirs.__len__()))
up.enter_to_proceed()
...
up.fetch_envs_new()
up.select_envs()
up.populate_files_after_env_filter()
print("Searched the matching files for {} for {} envs in {} selected child directories. "
      "Found {} matching files.".format(fileName, up.selected_envs, up.selected_dirs.__len__()
